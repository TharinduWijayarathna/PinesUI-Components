...
<div class="relative w-full rounded-lg border border-transparent p-4 {{ $typeClasses[$type] }} [&>svg]:absolute [&>svg]:text-foreground [&>svg]:left-4 [&>svg]:top-4 [&>svg+div]:translate-y-[-3px] [&:has(svg)]:pl-11">
